...
namespace lq
{
    ...
    void Application::init()
    {
        ...
        sage::ResourceManager::GetInstance().ImageUnload("application_icon");
        HideCursor();
    ...
    Application::Application()
        : registry(std::make_unique<entt::registry>()),
          cleanupSystem(std::make_unique<sage::CleanupSystem>(registry.get())),
          settings(std::make_unique<sage::Settings>(&exitWindow)),
          keyMapping(std::make_unique<sage::KeyMapping>())
    {
    }
} // namespace lq
