...
namespace lq
{
    class GameModeStateMachine::DefaultState : public sage::State
    {
      ...
      public:
        ...
        DefaultState(entt::registry* _registry, entt::entity _gameEntity, GameModeStateMachine* _stateController)
            : State(_registry), gameEntity(_gameEntity), stateController(_stateController)
        {
        }
    };
    ...
    class GameModeStateMachine::WaveState : public sage::State
    {
        GameModeStateMachine* stateController;
        void initWave()
        {
      ...
      public:
        ...
        WaveState(entt::registry* _registry, GameModeStateMachine* _stateController)
    ...
    class GameModeStateMachine::CombatState : public sage::State
    {
        GameModeStateMachine* stateController;
      ...
      public:
        ...
        CombatState(entt::registry* _registry, GameModeStateMachine* _stateController)
            : State(_registry), stateController(_stateController)
        {
        }
    };
    ...
    {
        states[GameStateEnum::Default] = std::make_unique<DefaultState>(registry, gameEntity, this);
        states[GameStateEnum::Wave] = std::make_unique<WaveState>(registry, this);
        states[GameStateEnum::Combat] = std::make_unique<CombatState>(registry, this);
