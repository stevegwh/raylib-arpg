...
entt::entity GameObjectFactory::createPlayer(entt::registry* registry, Vector3 position, const char* name) 
{
...
void GameObjectFactory::createTower(entt::registry* registry, Vector3 position, const char* name) 
{
