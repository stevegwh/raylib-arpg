...
namespace sage
{
    ...
    std::vector<std::string> FullscreenTextOverlayManager::divideTextOnNewLine(const std::string& str)
    {
    ...
    void FullscreenTextOverlayManager::setNextText()
    {
        ++currentTextIdx;
    ...
    void FullscreenTextOverlayManager::RemoveOverlay()
    {
        enabled = false;
        fadeIn = 0;
        fadeOut = 0;
    ...
    void FullscreenTextOverlayManager::SetOverlay(
    ...
    void FullscreenTextOverlayManager::Draw2D() const
    {
        if (!enabled) return;
    ...
    FullscreenTextOverlayManager::FullscreenTextOverlayManager(Systems* _sys)
        : font(
