...
int main(void)
{
    ...
    // Load gltf model
    Model characterModel = LoadModel("resources/models/gltf/hero-updated.glb"); // Load character model
    characterModel.transform = MatrixScale(0.035f, 0.035f, 0.035f);
    ...
    ModelAnimation* modelAnimations = LoadModelAnimations("resources/models/gltf/hero-updated.glb", &animsCount);
