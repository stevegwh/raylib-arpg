...
//		ecfg1.directionAngle = FloatRange{ -20, 20 };
//		ecfg1.velocity = FloatRange{ 0.5, 0.55 };
//		ecfg1.texture = texCircle16;
//		ecfg1.age = FloatRange{ 0.1, 0.4 };
//
//		auto emitterFountain3 = std::make_unique<Emitter>(ecfg1);
//		Register(std::move(emitterFountain3));
